...
public class GSVicio {
    ...
    public GSVicio(Gramatica gramatica) {
        ...
        gramatica.getProducciones().forEach(new BiConsumer<String, ArrayList<String>>() {
            @Override
            public void accept(String noTerminal, ArrayList<String> producciones) {
                if (GSVicio.this.esRecursivo(noTerminal, producciones)) {
                    GSVicio.this.quitarRecursividad(noTerminal, producciones);
                } else {
                    GSVicio.this.producciones.put(noTerminal, producciones);
                }
            }
        });
    ...
    public void resultados() {
        ...
        this.producciones.forEach(new BiConsumer<String, ArrayList<String>>() {
            @Override
            public void accept(String noTerminal, ArrayList<String> produccion) {
